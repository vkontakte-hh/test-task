...
> ``` crontab -l ``` Проверка наличия действующих задач на запуск <br>
> ``` crontab -r ``` Удаление списка задач <br>
> ``` crontab -e ``` Редактирования списка задач или создание нового <br>
